...
Vid sökning i en sorterad lista kan man istället använda binär sökning vilket innebär att man delar listan i två delar och därmed snabbt minskar sökområdet. Detta ger en tidskomplexitet på O(log n) i både genomsnittligt och värsta fall vilket är betydligt snabbare än linjär sökning. Minnesanvändningen är fortfarande låg eftersom ingen extra struktur krävs. Däremot ska man vara extra försiktigt när man sätter in nya element för att kunna bevara sorteringen. Därför är en sorterad lista lämplig när man gör många sökningar, relativt få förändringar och när det är viktigt att datan hålls i ordning. 

#### Sökning i en hash table
En hash table fungerar annorlunda genom att använda en hashfunktion för att direkt beräkna var ett element ska lagras. Detta gör att sökning i genomsnitt tar O(1) tid eftersom man kan gå direkt till rätt position utan att behöva jämföra flera element. I värsta kan dock tidskomplexiteten bli O(n) om till exempel att många kollisioner uppstår och flera element hamnar på samma plats. Däremot kräver hash tables mer minne än listor eftersom de använder en intern array och ibland ytterligare strukturer för att hantera kollisioner. Därför är de mest lämpliga när mycket snabba uppslag är viktiga och när ordningen på elementen inte spelar någon roll. 